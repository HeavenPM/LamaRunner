Shader "Simple Toon/SToon Outline"
{
	Properties
    {
        ...
        _Steps ("Steps", Range(1,25)) = 3.5
        _StpSmooth ("Smoothness", Range(0,1)) = 0.1
        _Offset ("Lit Offset", Range(-1,1.1)) = 0.07
        ...
        _Lumin ("Luminocity", Range(0,2)) = 0.1

		[Header(Outline)][Space(5)]  //outline
		_OtlColor ("Color", COLOR) = (0,0,0,1)
		_OtlWidth ("Width", Range(0,5)) = 3.5

        [Header(Shine)][Space(5)]  //shine
		[HDR] _ShnColor ("Color", COLOR) = (1,1,0,1)
        [Toggle] _ShnOverlap ("Overlap", Float) = 0

        _ShnIntense ("Intensity", Range(0,1)) = 0.15
        _ShnRange ("Range", Range(0,1)) = 0.5
        _ShnSmooth ("Smoothness", Range(0,1)) = 2.8
    }
